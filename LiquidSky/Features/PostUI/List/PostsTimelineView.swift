      ...
      do {
        ...
        // Debug logging to identify the issue
          ...
          if let firstPost = feed.feed.first {
            ...
            print("TimelineView: First post author: \(firstPost.post.author.actorHandle)")
          }
        #endif
        ...
        guard !validPosts.isEmpty else {
          ...
          throw NSError(
            ...
            userInfo: [NSLocalizedDescriptionKey: "Timeline data is incomplete. Please try again."])
        }
        ...
        do {
          ...
          guard !validPosts.isEmpty else {
            ...
            throw NSError(
              ...
              userInfo: [
                NSLocalizedDescriptionKey: "Timeline data is incomplete. Please try again."
              ])
          }
        ...
        do {
          ...
          if !validPosts.isEmpty {
            #if DEBUG
              print("TimelineView: Alternative approach successful with \(validPosts.count) posts")
            #endif
            let posts = await processFeed(validPosts, client: client.protoClient)
            PostNotificationManager.shared.process(posts: posts)
            return .loaded(posts: posts, cursor: feed.cursor)
          ...
          || error.localizedDescription.contains("incomplete")
        {
          ...
          throw NSError(
            ...
            userInfo: [
              NSLocalizedDescriptionKey: "Failed to load timeline: \(error.localizedDescription)"
            ])
        }
      }
